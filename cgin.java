...
public class cgin extends javax.swing.JFrame {
    public cgin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cgin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
